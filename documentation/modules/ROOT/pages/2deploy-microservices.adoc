...
[source,bash]
----
kubectl apply -f manifests/kubernetes/customer-deployment.yml
kubectl apply -f manifests/kubernetes/customer-service.yml
----
...
[source,bash]
----
kubectl apply -f manifests/kubernetes/preference-deployment-v1.yml
kubectl apply -f manifests/kubernetes/preference-service.yml
----
...
[source,bash]
----
kubectl apply -f manifests/kubernetes/recommendation-deployment-v1.yml
kubectl apply -f manifests/kubernetes/recommendation-service.yml
----
