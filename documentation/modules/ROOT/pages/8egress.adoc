...
[source, bash]
----
istioctl apply -f manifests/istio/destination-rule-recommendation-v1-v2-v3.yml -n tutorial
istioctl apply -f manifests/istio/virtual-service-recommendation-v3.yml
----
...
[source,bash]
----
istioctl apply -f manifests/istio/service-entry-egress-httpbin.yml -n tutorial
...
[source,bash]
----
oc exec -it $(kubectl get pods -o jsonpath="{.items[*].metadata.name}" -l app=recommendation,version=v3) -c recommendation /bin/bash

or

kubectl exec -it $(kubectl get pods -o jsonpath="{.items[*].metadata.name}" -l app=egressgithub,version=v3) -c recommendation /bin/bash
...
[source,bash]
----
istioctl delete -f manifests/istio/service-entry-egress-httpbin.yml -n tutorial
istioctl delete -f manifests/istio/destination-rule-recommendation-v1-v2-v3.yml -n tutorial
istioctl delete -f manifests/istio/virtual-service-recommendation-v3.yml
----
