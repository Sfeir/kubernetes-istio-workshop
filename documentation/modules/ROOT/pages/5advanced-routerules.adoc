...
[source,bash]
----
curl -A Safari $CUTOMER_URL
curl -A Firefox $CUTOMER_URL
----
...
curl -A "Mozilla/5.0 (iPhone; U; CPU iPhone OS 4(KHTML, like Gecko) Version/5.0.2 Mobile/8J2 Safari/6533.18.5" $CUTOMER_URL
----
