...
[source,bash]
----
curl -A Safari __CUSTOMER__
curl -A Firefox __CUSTOMER__
----
...
curl -A "Mozilla/5.0 (iPhone; U; CPU iPhone OS 4(KHTML, like Gecko) Version/5.0.2 Mobile/8J2 Safari/6533.18.5" __CUSTOMER__
----
