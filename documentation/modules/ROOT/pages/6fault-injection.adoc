...
curl $CUTOMER_URL  0.01s user 0.00s system 0% cpu 1.035 total
customer => preference => recommendation v1 from '2039379827-h58vw': 210
curl $CUTOMER_URL  0.01s user 0.00s system 36% cpu 0.025 total
customer => 503 preference => 504 upstream request timeout
curl $CUTOMER_URL  0.01s user 0.00s system 0% cpu 1.034 total
----
