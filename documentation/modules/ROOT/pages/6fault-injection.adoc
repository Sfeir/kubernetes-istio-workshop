...
[source,bash]
----
istioctl apply -f manifests/istio/destination-rule-recommendation.yml -n tutorial
istioctl apply -f manifests/istio/virtual-service-recommendation-503.yml -n tutorial
...
[source,bash]
----
istioctl delete -f manifests/istio/virtual-service-recommendation-503.yml -n tutorial
----
...
[source,bash]
----
istioctl apply -f manifests/istio/virtual-service-recommendation-delay.yml -n tutorial
----
...
[source]
----
istioctl delete -f manifests/istio/destination-rule-recommendation.yml -n tutorial
istioctl delete -f manifests/istio/virtual-service-recommendation-delay.yml -n tutorial
----
...
[source,bash]
----
istioctl apply -f manifests/istio/virtual-service-recommendation-v2_retry.yml -n tutorial
----
...
[source,bash]
----
istioctl apply -f manifests/istio/virtual-service-recommendation-timeout.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f manifests/istio/virtual-service-recommendation-timeout.yml -n tutorial
----
