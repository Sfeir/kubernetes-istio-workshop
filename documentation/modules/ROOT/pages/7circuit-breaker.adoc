...
[source,bash]
----
istioctl apply -f manifests/istio/destination-rule-recommendation-v1-v2.yml -n tutorial
istioctl apply -f manifests/istio/virtual-service-recommendation-v1_and_v2_50_50.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f manifests/istio/destination-rule-recommendation_cb_policy_version_v2.yml -n tutorial
...
istioctl delete -f manifests/istio/destination-rule-recommendation_cb_policy_version_v2.yml -n tutorial
----
...
[source,bash]
----
oc exec -it $(kubectl get pods|grep recommendation-v2|awk '{ print $1 }'|head -1) -c recommendation /bin/bash
or
...
[source,bash]
----
istioctl replace -f manifests/istio/destination-rule-recommendation_cb_policy_pool_ejection.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f manifests/istio/virtual-service-recommendation-v1_and_v2_retry.yml -n tutorial
----
