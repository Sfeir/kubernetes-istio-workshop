...
[source,bash]
----
istioctl create -f manifests/istio/simple-routing/recommendation-destination-rule-v1-v2.yml -n tutorial
istioctl create -f manifests/istio/simple-routing/recommendation-virtual-service-v2.yml -n tutorial
