...
[source, bash]
----
istioctl apply -f manifests/istio/destination-rule-recommendation-v1.yml -n tutorial
istioctl apply -f manifests/istio/virtual-service-recommendation-virtualized.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f manifests/istio/destination-rule-recommendation-v1.yml -n tutorial
istioctl delete -f manifests/istio/virtual-service-recommendation-virtualized.yml -n tutorial
