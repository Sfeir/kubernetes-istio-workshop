...
[source, bash]
----
istioctl apply -f manifests/istio/gateway-customer.yml
----
...
[source, bash]
----
istioctl apply -f manifests/istio/authentication-enable-tls.yml # <1>
istioctl apply -f manifests/istio/destination-rule-tls.yml # <2>
----
...
[source, bash]
----
istioctl delete -f manifests/istio/authentication-enable-tls.yml
istioctl delete -f manifests/istio/destination-rule-tls.yml
----
...
source,bash]
----
istioctl delete -f manifests/istio/gateway-customer.yml
----
