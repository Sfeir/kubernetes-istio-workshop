...
- You already cloned the directory : ``https://github.com/Sfeir/kubernetes-istio-workshop`` and make sure that all operations will take place into the root of the ``kubernetes-istio-workshop`` directory.
====
