...
[source, bash,subs="+macros,+attributes"]
----
kubectl create -f link:{github-repo}/manifests/istio/security/end-user_authentication/enduser-authentication-jwt.yml[manifests/istio/security/enduser-authentication-jwt.yml]
----
...
[source, bash, subs="+macros,+attributes"]
----
curl -H "Authorization: Bearer $token" $CUSTOMER_URL
...
[source, bash, subs="+macros,+attributes"]
----
kubectl delete -f link:{github-repo}/manifests/istio/security/end-user_authentication/enduser-authentication-jwt.yml[manifests/istio/security/enduser-authentication-jwt.yml]
----
