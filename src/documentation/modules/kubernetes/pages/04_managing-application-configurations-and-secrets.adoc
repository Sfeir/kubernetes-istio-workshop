...
*Note:* _You can also explore Secrets and ConfigMaps in GKE console, from the_ Configuration _menu._
...
* Mount of these volumes in the `nginx` container
...
xref:kubernetes:05_creating-and-managing-services.adoc[Next >]