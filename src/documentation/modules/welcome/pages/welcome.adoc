...
Let's start by connecting to https://console.cloud.google.com/projectselector/home/dashboard?organizationId=670174100971[GCP Console]. Log in and select the project named "Workshop Istio XXX".
