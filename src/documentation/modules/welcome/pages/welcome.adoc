...
and a hosted command line environment: https://cloud.google.com/shell/[Google Cloud Shell].

Cloud Shell is a Debian-based virtual machine provisionned with all the
development tools you'll need (Kubernetes, Docker, Terraform, Python, Java, Node, etc.).

It offers a persistent 5GB home directory.

__This means that all you will need for this workshop is a browser.__

Let's start by connecting to https://console.cloud.google.com/projectselector/home/dashboard?organizationId=670174100971[GCP Console]. Log in and select the project named "Workshop Istio".
...
xref:kubernetes:01_setup.adoc[Next >]